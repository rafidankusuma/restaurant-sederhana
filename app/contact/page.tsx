            ...
            <div className="max-w-screen-xl mx-auto py-20 px-4">
                <div className="grid md:grid-cols-2 gap-8">
                    <div>
                        ...
                        <h1 className="text-5xl font-semibold text-gray-900 mb-4">Get In Touch Today
                        </h1>
                        <p className="text-gray-700 py-5">Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                            Neque autem corrupti provident laborum, voluptates sint.</p>
                        <ul className="list-item space-y-6 pt-8">
                            ...
                            <li className="flex gap-5">
                                ...
                                <div className="flex-1">
                                    ...
                                    <p>+9821 1238 1233, +8498 3124 9182</p>
                                </div>
                            </li>
                            <li className="flex gap-5">
                                <div className="flex-none bg-gray-300 p-3 shadow-sm rounded-sm">
