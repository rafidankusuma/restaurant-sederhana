...
import { updateFood } from "@/lib/actions";
...
const EditForm = ({ 
    ...
    const [state, formAction, isPending] = useActionState(
        updateFood.bind(null, image, food.id), 
        null
    );

    const checkedAmenities = food.FoodAmenities.map((item) => item.amenitiesId);
        ...
        <form action={formAction}>
            <div className="grid md:grid-cols-12 gap-5">
                ...
                <div className="col-span-4 bg-white p-4">
                    <label
                        htmlFor="input-file"
                        className="flex flex-col mb-4 items-center justify-center aspect-video border-2 
                        border-gray-300 border-dashed rounded-md cursor-pointer bg-gray-50 relative">
                        ...
                        pb-6 z-10">
                            ...
                            {image ? (
                                <button
                                    ...
                                    className="flex items-center justify-center bg-transparent size-6 rounded-sm 
                                absolute right-1 top-1 text-white hover:bg-red-400">
